        ...
        >
          <View className="flex-1 px-6 pb-8">
            ...
            <View className="gap-4 mt-[-10px] relative z-0">
              ...
              {/* Password Card Input */}
              <View
                className={`h-[72px] bg-white border rounded-2xl px-4 py-3 flex-row items-center justify-between ${
                  passwordError ? "border-error" : "border-slate-200 focus-within:border-lingua-purple"
                }`}
              >
                <View className="flex-1 justify-center">
                  <Text className="text-[12px] font-medium text-slate-400">Password</Text>
                  <TextInput
                    value={password}
                    onChangeText={(text) => {
                      setPassword(text);
